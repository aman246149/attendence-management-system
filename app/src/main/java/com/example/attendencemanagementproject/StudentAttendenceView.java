...
public class StudentAttendenceView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       viewStudentID.setText(student_detail.getStudent_id());
       ...
       viewSemester.setText(student_detail.getSemester());
       viewYEar.setText(student_detail.getYear());
       viewGender.setText(student_detail.getGender());
       viewRollno.setText(student_detail.getRoll_number());
