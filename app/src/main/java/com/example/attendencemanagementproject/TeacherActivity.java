...
public class TeacherActivity extends AppCompatActivity {
    ...
    DATABASE_HANDLER_Student db=new DATABASE_HANDLER_Student(TeacherActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String pass=TeacherLogin.getText().toString();
                ...
                {
                    Toast.makeText(TeacherActivity.this, "wrong student id", Toast.LENGTH_SHORT).show();
                }
